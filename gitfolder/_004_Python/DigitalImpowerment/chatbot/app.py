...
openai.api_key = "sk-9SRxSPds5RSYbtD9gNYQT3BlbkFJcHDqXzOYTASYw4BVLtdb123"
...
def openai_create(prompt):
    response = openai.Completion.create(
        ...
        prompt=prompt,
        temperature=0.9, #0에서 1사이/ 창의성을 뜻함
        max_tokens=150, #답변을 하는 단위 
        top_p=1, #확률 분포(정답인 확률이 높을 것을)
        frequency_penalty=0,
